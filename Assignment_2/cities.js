...
function guessIt() {
	...
	*/
	/////////////////////////////////////////////////////////////////////////////////////////////////
	let guess = form1.guess1.value.toUpperCase();
	tries++;
	guessStatus();
	/////////////////////////////////////////////////////////////////////////////////////////////////
	/* 	INSTRUCTIONS: Part 5
	...
	switch (tries) {
		case 1:
			document.form1.hint.value =
				"First Hint: The city name starts with '" + cityName.charAt(0) + "'";
			break;
		case 2:
			document.form1.hint.value =
				"Second Hint: The city name ends with '" +
				cityName.charAt(cityName.length - 1) +
				"'";
			break;
		case 3:
			document.form1.hint.value =
				"Last Hint: The city name has " + cityName.length + " characters";
			break;
		default:
			document.form1.hint.value =
				"No more hints available! Last chance to guess!";
			break;
	}

	if (guess.toUpperCase() == cityName) {
		// Checks if guess equals cityName
		if (
			window.confirm(
				"You are correct!\n\nThe city was " +
					cityName +
		...
		if (tries == 5) {
			// Game over without a correct guess
			if (
				window.confirm(
				...
				window.location.reload(); // Reloads the page for a new game
				document.form1.hint.value =
					"Enter a City name below and click Guess button!";
				document.form1.attempts.value = "Tries :0";
			}
		}
	}
}
...
function guessStatus() {
	document.form1.attempts.value = "Tries :" + tries;
}
